...
**P0 — Ship is complete.** M1 (front door), M2 (CI, release, safety infra), M3 (backlog triage), and M4 (sandbox resolution / sandbox-free onboarding) have all shipped. Marianne now has automated CI (ruff + mypy --strict + pytest with an 80% coverage gate, ~10,300 tests, 85% coverage), a reproducible `uv.lock`, dependency scanning, a `v0.1.0-alpha` release, a fully tier-labeled + milestone-assigned backlog, and a sandbox-free quickstart.

**Next: P1 — Launch.** Focus shifts to M5 (Baton Stabilization), M6 (Onboarding & Pre-Launch), and M7 (Market Positioning).
...
gantt
    ...
    M2 CI & Release             :done, m2, 2026-04-21, 2026-05-29
    M3 Backlog Triage           :done, m3, 2026-04-21, 2026-05-29
    M4 Sandbox Resolution       :done, m4, 2026-04-21, 2026-05-29
...
**Priority:** P0 | **Status:** Done (2026-05-29) | **Depends on:** nothing (parallel with M1, M3)
...
**Priority:** P0 | **Status:** Done (2026-05-29) | **Depends on:** nothing (parallel with M1, M2)
...
**Priority:** P0 | **Status:** Done (2026-05-29) | **Depends on:** nothing

Critical path gate. Either the sandbox P0 is resolved architecturally OR a validated sandbox-free quickstart path exists. **Resolved via the contingency:** the `code_mode` bwrap sandbox bug ([#210](https://github.com/Mzzkc/marianne-ai-compose/issues/210)) remains open (it is opt-in and unused by the onboarding path), and a validated sandbox-free quickstart now exists.

| Issue | Title | Size | Status |
|-------|-------|------|--------|
| [#285](https://github.com/Mzzkc/marianne-ai-compose/issues/285) | Contingency: sandbox-free quickstart path | M | Closed |
